              ...
              {currentItems.map((temple:any) => (
                ...
                >
                  ...
                  <div className="p-5 text-left">
                    ...
                    <Button onClick={()=>router.push(`/details/${temple.id}`)} className="bg-[#800000] text-white px-4 py-2 rounded-full text-sm hover:bg-[#a00000] transition">
                      View Details
                    </Button>
                  </div>
                </div>
